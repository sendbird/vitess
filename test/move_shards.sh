...
cd "$VTROOT/examples/move_shards"
...
vtctlclient Workflow customer.cust2cust_reverse delete

#./306_down_shard_0.sh


./501_customer2_shards.sh

./502_customer2_sharded.sh
