...
var (
	...
	ApplyShardRoutingRules = &cobra.Command{
		...
		Short:                 "Applies the VSchema shard routing rules.",
	...
	GetShardRoutingRules = &cobra.Command{
		...
		Short:                 "Displays the VSchema shard routing rules.",
		DisableFlagsInUseLine: true,
		Args:                  cobra.NoArgs,
...
func init() {
	ApplyShardRoutingRules.Flags().StringVarP(&applyShardRoutingRulesOptions.Rules, "rules", "r", "", "Routing rules, specified as a string")
	ApplyShardRoutingRules.Flags().StringVarP(&applyShardRoutingRulesOptions.RulesFilePath, "rules-file", "f", "", "Path to a file containing routing rules specified as JSON")
	...
	ApplyShardRoutingRules.Flags().BoolVarP(&applyShardRoutingRulesOptions.DryRun, "dry-run", "d", false, "Load the specified routing rules as a validation step, but do not actually apply the rules to the topo.")
