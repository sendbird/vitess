...
// with a new one.
// An idleTimeout of 0 means that there is no idle timeout.
// If a resource is returned to the pool refreshTimeout after creation,
// it is replaced.
// A refreshTimeout of 0 means no connection refresh based on lifetime
