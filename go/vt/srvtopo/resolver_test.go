...
func TestResolveDestinations(t *testing.T) {
	...
	for _, testCase := range testCases {
		ctx := context.Background()
		rss, values, err := resolver.ResolveDestinations(ctx, testCase.keyspace, []topodatapb.TabletType{topodatapb.TabletType_REPLICA}, testCase.ids, testCase.destinations)
		if err != nil {
