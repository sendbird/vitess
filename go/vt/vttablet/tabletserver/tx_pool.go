...
func NewTxPool(
	...
	axp := &TxPool{
		conns:         connpool.New(prefix+"TransactionPool", capacity, prefillParallelism, idleTimeout, tsv),
		foundRowsPool: connpool.New(prefix+"FoundRowsPool", foundRowsCapacity, prefillParallelism, idleTimeout, tsv),
