...
func (conn *gRPCQueryClient) VStreamRows(ctx context.Context, target *querypb.Target, query, piiStrategy string, lastpk *querypb.QueryResult, send func(*binlogdatapb.VStreamRowsResponse) error) error {
