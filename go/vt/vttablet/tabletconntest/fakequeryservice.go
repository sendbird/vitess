...
func (f *FakeQueryService) VStreamRows(ctx context.Context, target *querypb.Target, query, piiStrategy string, lastpk *querypb.QueryResult, send func(*binlogdatapb.VStreamRowsResponse) error) error {
	panic("not implemented")
}
