...
func (c *replicaConnector) VStreamRows(ctx context.Context, query, piiStrategy string, lastpk *querypb.QueryResult, send func(*binlogdatapb.VStreamRowsResponse) error) error {
