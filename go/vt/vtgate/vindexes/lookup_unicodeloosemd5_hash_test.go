...
func TestLookupUnicodeLooseMD5HashMap(t *testing.T) {
	...
	got, err := lookup.Map(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10), sqltypes.NewInt64(20)})
...
func TestLookupUnicodeLooseMD5HashMapAutocommit(t *testing.T) {
	...
	got, err := lookupNonUnique.Map(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10), sqltypes.NewInt64(20)})
	require.NoError(t, err)
	want := []key.Destination{
		key.DestinationKeyspaceIDs([][]byte{
			[]byte("\x16k@\xb4J\xbaK\xd6"),
...
func TestLookupUnicodeLooseMD5HashVerify(t *testing.T) {
	...
	got, err := lookupNonUnique.Verify(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10), sqltypes.NewInt64(20)}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6"), []byte("\x06\xe7\xea\"Βp\x8f")})
	require.NoError(t, err)
	...
	// Test query fail.
	vc.mustFail = true
	_, err = lookupNonUnique.Verify(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(1)}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6")})
	...
	got, err = lookupNonUnique.Verify(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10), sqltypes.NewInt64(20)}, [][]byte{[]byte(""), []byte("")})
	require.NoError(t, err)
	if vc.queries != nil {
...
func TestLookupUnicodeLooseMD5HashVerifyAutocommit(t *testing.T) {
	...
	_, err = lookupNonUnique.Verify(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10), sqltypes.NewInt64(20)}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6"), []byte("\x06\xe7\xea\"Βp\x8f")})
	require.NoError(t, err)
...
func TestLookupUnicodeLooseMD5HashCreate(t *testing.T) {
	...
	err := lookupNonUnique.(Lookup).Create(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(10)}, {sqltypes.NewInt64(20)}}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6"), []byte("\x06\xe7\xea\"Βp\x8f")}, false)
	require.NoError(t, err)
	...
	// With ignore.
	vc.queries = nil
	err = lookupNonUnique.(Lookup).Create(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(10)}, {sqltypes.NewInt64(20)}}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6"), []byte("\x06\xe7\xea\"Βp\x8f")}, true)
	require.NoError(t, err)
	...
	// Test query fail.
	vc.mustFail = true
	err = lookupNonUnique.(Lookup).Create(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(10)}}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6")}, false)
	...
	err = lookupNonUnique.(Lookup).Create(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(10), sqltypes.NewInt64(20)}}, [][]byte{[]byte("\x16k@\xb4J\xbaK\xd6")}, false)
...
func TestLookupUnicodeLooseMD5HashCreateAutocommit(t *testing.T) {
	...
	err = lookupNonUnique.(Lookup).Create(ctx, vc, [][]sqltypes.Value{{
...
func TestLookupUnicodeLooseMD5HashDelete(t *testing.T) {
	...
	err := lookupNonUnique.(Lookup).Delete(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(10)}, {sqltypes.NewInt64(20)}}, []byte("\x16k@\xb4J\xbaK\xd6"))
	require.NoError(t, err)
	...
	// Test query fail.
	vc.mustFail = true
	err = lookupNonUnique.(Lookup).Delete(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(1)}}, []byte("\x16k@\xb4J\xbaK\xd6"))
	...
	err = lookupNonUnique.(Lookup).Delete(ctx, vc, [][]sqltypes.Value{{sqltypes.NewInt64(1), sqltypes.NewInt64(2)}}, []byte("\x16k@\xb4J\xbaK\xd6"))
...
func TestLookupUnicodeLooseMD5HashUpdate(t *testing.T) {
	...
	err := lookupNonUnique.(Lookup).Update(ctx, vc, []sqltypes.Value{sqltypes.NewInt64(10)}, []byte("\x16k@\xb4J\xbaK\xd6"), []sqltypes.Value{sqltypes.NewInt64(20)})
	require.NoError(t, err)
