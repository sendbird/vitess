...
func (r *Rows) TryExecute(VCursor, map[string]*querypb.BindVariable, bool, *RoutingParameters) (*sqltypes.Result, error) {
...
func (r *Rows) TryStreamExecute(vcursor VCursor, bindVars map[string]*querypb.BindVariable, wantields bool, callback func(*sqltypes.Result) error) error {
	result, err := r.TryExecute(vcursor, bindVars, wantields, nil)
	if err != nil {
		return err
	}
