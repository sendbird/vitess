...
func (del *Delete) TryExecute(vcursor VCursor, bindVars map[string]*querypb.BindVariable, _ bool, _ *RoutingParameters) (*sqltypes.Result, error) {
...
func (del *Delete) TryStreamExecute(vcursor VCursor, bindVars map[string]*querypb.BindVariable, wantfields bool, callback func(*sqltypes.Result) error) error {
	res, err := del.TryExecute(vcursor, bindVars, wantfields, nil)
	if err != nil {
		return err
	}
	return callback(res)
