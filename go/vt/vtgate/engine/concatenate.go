...
func (c *Concatenate) TryExecute(vcursor VCursor, bindVars map[string]*querypb.BindVariable, wantfields bool, routing *RoutingParameters) (*sqltypes.Result, error) {
