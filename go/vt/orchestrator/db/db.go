...
type DB interface {
	QueryOrchestrator(query string, argsArray []interface{}, onRow func(sqlutils.RowMap) error) error
}
...
func (m *vtorcDB) QueryOrchestrator(query string, argsArray []interface{}, onRow func(sqlutils.RowMap) error) error {
