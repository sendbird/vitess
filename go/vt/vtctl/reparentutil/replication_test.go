	...
	}{
		{
			...
			tmc: &stopReplicationAndBuildStatusMapsTestTMClient{
				stopReplicationAndGetStatusResults: map[string]*struct {
					...
					"zone1-0000000100": {
						StopStatus: &replicationdatapb.StopReplicationStatus{
							Before: &replicationdatapb.Status{Position: "100-before", IoThreadRunning: true, SqlThreadRunning: true},
							After:  &replicationdatapb.Status{Position: "100-after"},
						},
					},
					"zone1-0000000101": {
						StopStatus: &replicationdatapb.StopReplicationStatus{
							Before: &replicationdatapb.Status{Position: "101-before", IoThreadRunning: true, SqlThreadRunning: true},
