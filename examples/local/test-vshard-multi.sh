...
export DST_KS1=dst_ks1
export DST_KS2=dst_ks2
export SRC_TABLET_ID=test-100
export DST_TABLET_ID1=test-200
export DST_TABLET_ID2=test-300
export TABLE_NAME1=moving1
export TABLE_NAME2=moving2
...
./lvtctl.sh CreateKeyspace $DST_KS1
./lvtctl.sh CreateKeyspace $DST_KS2
./lvtctl.sh GetSrvKeyspaceNames test
KEYSPACE=$DST_KS1 UID_BASE=200 ./vttablet-up.sh
KEYSPACE=$DST_KS2 UID_BASE=300 ./vttablet-up.sh
./lvtctl.sh InitShardMaster -force $DST_KS1/0 $DST_TABLET_ID1
./lvtctl.sh InitShardMaster -force $DST_KS2/0 $DST_TABLET_ID2
...
./lvtctl.sh CopySchemaShard -tables=$TABLE_NAME1 $SRC_KS/0 $DST_KS1/0
./lvtctl.sh CopySchemaShard -tables=$TABLE_NAME2 $SRC_KS/0 $DST_KS2/0
./lvtctl.sh GetSchema $DST_TABLET_ID1
./lvtctl.sh GetSchema $DST_TABLET_ID2
./lvtctl.sh GetSchema $SRC_TABLET_ID
./lvtctl.sh VerticalSplitClone $SRC_KS $DST_KS1 $TABLE_NAME1
./lvtctl.sh GetSchema $DST_TABLET_ID1
./lvtctl.sh ShowResharding $DST_KS1/0

./lvtctl.sh VerticalSplitClone $SRC_KS $DST_KS2 $TABLE_NAME2
./lvtctl.sh GetSchema $DST_TABLET_ID2
./lvtctl.sh ShowResharding $DST_KS2/0
...
./lvtctl.sh MigrateServedFrom $DST_KS1/0 rdonly
curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom $DST_KS2/0 rdonly
curl http://localhost:15001/debug/vschema
./203a_vertical_split_diff.sh
curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom $DST_KS1/0 replica
curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom $DST_KS2/0 replica
curl http://localhost:15001/debug/vschema
# ./lvtctl.sh MigrateServedFrom -reverse $DST_KS/0 replica
# curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom -reverse $DST_KS1/0 rdonly
curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom -reverse $DST_KS2/0 rdonly
curl http://localhost:15001/debug/vschema
./lvtctl.sh MigrateServedFrom $DST_KS/0 replica
curl http://localhost:15001/debug/vschema

./lvtctl.sh MigrateServedFrom --reverse_replication $DST_KS1/0 master
./lvtctl.sh MigrateServedFrom --reverse_replication $SRC_KS/0 master
./lvtctl.sh MigrateServedFrom --reverse_replication $DST_KS2/0 master
curl http://localhost:15001/debug/vschema
...
./lvtctl.sh CancelResharding $DST_KS1/0
./lvtctl.sh CancelResharding $SRC_KS/0
./lvtctl.sh ShowResharding $DST_KS/0
./lvtctl.sh ShowResharding $SRC_KS/0
./lvtctl.sh SetShardTabletControl --remove
